<section id="brand-seoService">
    <div class="brand-seo-service">
        <?php
        ...
        ?>
        <div class="brand-seo-service-top">
            <figure class="brand-seo-service-top-floatingimg-1">
                <img src=<?= wp_get_attachment_image_src(244)[0] ?> alt="">
            </figure>
            <figure class="brand-seo-service-top-floatingimg-2">
                <img src=<?= wp_get_attachment_image_src(220)[0] ?> alt="">
            </figure>
            <div class="brand-seo-service-top-header">
                <div class="brand-seo-service-top-header-title">
                    <p><?= $top_header_title ?></p>
                </div>
                <div class="brand-seo-service-top-header-description">
                    <p><?= $top_header_description ?></p>
                </div>
            </div>
            <div class="brand-seo-service-top-group">
                <?php foreach ($services as $service) { ?>
                <div class="brand-seo-service-top-group-box">
                    <figure>
                        <img src=<?= $service['icon'] ?> alt="">
                    </figure>
                    <div class="brand-seo-service-top-group-box-title">
                        <p><?= $service['title'] ?></p>
                    </div>
                    <div class="brand-seo-service-top-group-box-line"></div>
                    <div class="brand-seo-service-top-group-box-description">
        ...
        <div class="brand-seo-service-bot">
            <figure class="brand-seo-service-bot-floatingimg-1">
                <img src=<?= wp_get_attachment_image_src(191)[0] ?> alt="">
            </figure>
            <figure class="brand-seo-service-bot-floatingimg-2">
                <img src=<?= wp_get_attachment_image_src(143)[0] ?> alt="">
            </figure>
            <div class="brand-seo-service-bot-header">
                <div class="brand-seo-service-bot-header-title">
                    <p><?= $bot_header_title ?></p>
                </div>
                <div class="brand-seo-service-bot-header-description">
                    <p><?= $bot_header_description ?>
                    </p>
                </div>
            </div>
            <div class="brand-seo-service-bot-group">
                <div class="brand-seo-service-bot-group-left">
                    <div class="brand-seo-service-bot-group-left-title">
                        <p><?= $bot_title ?></p>
                    </div>
                    <div class="brand-seo-service-bot-group-left-description">
                ...
                <figure class="brand-seo-service-bot-group-right">
                    <img src=<?= wp_get_attachment_image_src(1044)[0] ?> alt="">
                </figure>
            </div>
        </div>
        <?php }
